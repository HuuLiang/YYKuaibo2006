...
@implementation YYKHomeRankingCell
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _tagImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"ranking_tag"]];
