...
//        }
//    }];
    NSString *videoUrl =  [YYKUtil encodeVideoUrlWithVideoUrlStr:self.program.spareUrl];
    
    NSMutableString *videoSources = [[NSMutableString alloc] initWithFormat:@"<source src='%@' />", videoUrl];
    if (self.program.spareUrl.length > 0) {
        [videoSources appendFormat:@"<source src='%@' />", videoUrl];
    }
