//
//  YYKWeChatPayQueryOrderRequest.h
//  kuaibov
//
...
typedef void (^YYKWeChatPayQueryOrderCompletionHandler)(BOOL success, NSString *trade_state, double total_fee);

@interface YYKWeChatPayQueryOrderRequest : NSObject
