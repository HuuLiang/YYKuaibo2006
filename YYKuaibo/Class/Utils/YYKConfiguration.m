...
@implementation JQKConfiguration

+ (instancetype)sharedConfig {
    static JQKConfiguration *_config;
...
+ (instancetype)sharedStandbyConfig {
    static JQKConfiguration *_standbyConfig;
...
+ (instancetype)configWithName:(NSString *)configName {
    ...
    JQKConfiguration *config = [[self alloc] initWithDictionary:configDic];
    return config;
}
