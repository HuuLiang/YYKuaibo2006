...
#define KEY         @"smkl3osp1osldaaa" //key，可自行修改
...
#pragma mark - AES加密
//将string转成带密码的data
+(NSString*)encryptAESData:(NSString*)string andKey:(NSString*)key
{
    //将nsstring转化为nsdata
...
#pragma mark - AES解密
//将带密码的data转成string
+(NSString*)decryptAESData:(NSString *)string andKey:(NSString*)key
{
    //base64解密
